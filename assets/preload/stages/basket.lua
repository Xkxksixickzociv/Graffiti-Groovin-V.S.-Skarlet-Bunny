function onCreate()
	makeLuaSprite('bg', 'city_shit', -1100, -750)
	addLuaSprite('bg', false)
	makeLuaSprite('court', 'floor', -1100, -750)
	...
	if songName == 'ignited' then
		makeAnimatedLuaSprite('fgNene', 'nene', -600, 660)
		...
		makeAnimatedLuaSprite('fgOther', 'pico', 1500, 600)
	...
	elseif songName == 'philly-nice' then
		makeAnimatedLuaSprite('fgNene', 'nene', 1500, 640)
		...
		makeAnimatedLuaSprite('fgOther', 'darnell', -600, 600)
